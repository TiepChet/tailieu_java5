...
public class TaiKhoanServiceImpl implements TaiKhoanService {
    ...
    public Page<TaiKhoan> search(String ten, Pageable pageable) {
        return taiKhoanRepo.search("%"+ten+"%",pageable);
    }

    @Override
    public Page<TaiKhoan> hoatDong(Pageable pageable) {
        return taiKhoanRepo.hoatDong(pageable);
    }

    @Override
    public Page<TaiKhoan> sapXep(Pageable pageable) {
        return taiKhoanRepo.sapXep(pageable);
    }
}
