        ...
        <div class="col-9">
                            ...
                            <a href="/detail/${p.id}" class="product-item">
                                ...
                                <div class="item-info">
                                    ...
                                    <div>
                                        ...
                                        <span class="price">
                                            <fmt:formatNumber
                                                    value="${p.price}" pattern="#,###"></fmt:formatNumber>₫</span>
                                    </div>
                                </div>
                            </a>
                        </div>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="?page=${productList.number-1}">&lsaquo;</a></li>
                    <li class="page-item"><a class="page-link" href="?page=${productList.number+1}">&rsaquo;</a></li>
                    <li class="page-item"><a class="page-link" href="?page=${productList.totalPages-1}">&raquo;</a>
                    </li>
                </ul>
            </nav>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link">Số thực thể hiện
                        tại: ${productList.numberOfElements} </a></li>
                    <li class="page-item"><a class="page-link">Trang số: ${productList.number}</a></li>
                    <li class="page-item"><a class="page-link">Tổng số thực thể: ${productList.totalElements}</a></li>
                    <li class="page-item"><a class="page-link">Tổng số trang: ${productList.totalPages}</a></li>
                </ul>
            </nav>
