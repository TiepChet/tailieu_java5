...
public class GioHangServiceImpl implements GioHangService {
    ...
    @Override
    public Page<GioHang> searchAll(String ngayTao, String ngayCapNhap, KhachHang khachHang, Pageable pageable) {
        return gioHangRepo.searchAll(ngayTao,ngayCapNhap,khachHang,pageable);
    }

    @Override
    public Page<GioHang> searchKH(KhachHang khachHang, Pageable pageable) {
        return gioHangRepo.searchKH(khachHang,pageable);
    }
}
