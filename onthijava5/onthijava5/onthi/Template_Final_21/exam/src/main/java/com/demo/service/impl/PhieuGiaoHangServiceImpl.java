...
public class PhieuGiaoHangServiceImpl implements PhieuGiaoHangService {
    ...
    @Override
    public Page<PhieuGiaoHang> searchAll(String ngayGiao, String ngayNhan, HoaDon hoaDon, Pageable pageable) {
        return phieuGiaoHangRepo.searchAll(ngayGiao, ngayNhan, hoaDon, pageable);
    }

    @Override
    public Page<PhieuGiaoHang> searchCBB(HoaDon hoaDon, Pageable pageable) {
        return phieuGiaoHangRepo.searchCBB(hoaDon, pageable);
    }
}
