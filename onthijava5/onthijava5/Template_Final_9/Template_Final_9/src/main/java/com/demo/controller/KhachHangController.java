...
public class KhachHangController {
    ...
    @Autowired
    HangKhachHangService hangKhachHangServicel;

    @GetMapping("/khach-hang/hien-thi")
    public String hienThi(@ModelAttribute("khachHang") KhachHang khachHang, @RequestParam(defaultValue = "0") Integer page,
                          Model model) {
        Pageable pageable = PageRequest.of(page, 5);
        Page<KhachHang> listKH = khachHangService.getAll(pageable);
        List<HangKhachHang> listHKH = hangKhachHangServicel.getAll();
    ...
    public String update(@Valid @ModelAttribute("khachHang") KhachHang khachHang, BindingResult result,
                         @RequestParam(defaultValue = "0") Integer page, Model model, @PathVariable("maKhachHang") long maKhachHang) {
        if (result.hasErrors()) {
            Pageable pageable = PageRequest.of(page, 5);
            Page<KhachHang> listKH = khachHangService.getAll(pageable);
            List<HangKhachHang> listHKH = hangKhachHangServicel.getAll();
    ...
    public String search(@ModelAttribute("khachHang") KhachHang khachHang, @RequestParam(defaultValue = "0") Integer page, Model model,
                         @RequestParam("nhapGiaTri") String nhapGiaTri, @RequestParam("hangKhachHang") HangKhachHang hangKhachHang) {
        Pageable pageable = PageRequest.of(page, 5);
