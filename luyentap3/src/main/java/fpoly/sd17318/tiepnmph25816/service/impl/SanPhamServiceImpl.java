...
public class SanPhamServiceImpl implements SanPhamService {
    ...
    public SanPhamServiceImpl() {
        listSanPham.add(new SanPham(1, "SP001", "a", 10, "loai 1"));
        listSanPham.add(new SanPham(2, "SP002", "b", 2, "loai 2"));
        listSanPham.add(new SanPham(3, "SP003", "c", 20, "loai 3"));
        listSanPham.add(new SanPham(4, "SP004", "d", 12, "loai 4"));
    }
    ...
    @Override
    public List<SanPham> loai1(List<SanPham> list, String loai) {
        List<SanPham> listSanPham = new ArrayList<>();
        for (int i = 0; i < list.size(); i++) {
