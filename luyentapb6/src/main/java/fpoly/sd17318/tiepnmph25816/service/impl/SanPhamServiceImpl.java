...
public class SanPhamServiceImpl implements SanPhamService {
    ...
    public SanPhamServiceImpl() {
        ...
        listSanPham.add(new SanPham(2, "sp002", "B", 21, false, "loai 2"));
        listSanPham.add(new SanPham(3, "sp003", "C", 5, true, "loai 3"));
        listSanPham.add(new SanPham(4, "sp004", "D", 14, false, "loai 4"));
    }
