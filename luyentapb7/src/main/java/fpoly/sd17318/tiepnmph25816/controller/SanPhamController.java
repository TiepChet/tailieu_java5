...
public class SanPhamController {
    ...
    public String sanPhamNam(@ModelAttribute("sp") SanPham sanPham, Model model) {
        listSanPham = sanPhamService.sanPhamNam(listSanPham, true);
        model.addAttribute("listSanPham", listSanPham);
        return "hien-thi";
    }
...
//        model.addAttribute("sp", new SanPham());
    ...
    public String update(@Valid @ModelAttribute("sp") SanPham sanPham, BindingResult result, @PathVariable("id") int id, Model model) {
        if (result.hasErrors()) {
            model.addAttribute("listSanPham", listSanPham);
            return "update";
        }
